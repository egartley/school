...
public class Host {
	...
	String id, name, since, location, about, responseTime;
	double responseRate, acceptanceRate; 
	boolean isSuperHost; 
	
	Host(String id, String name, String since, String location, String about, String responseTime, double responseRate, double acceptanceRate, boolean isSuperHost){
		this.id = id;
		this.name = name; 
		this.since = since;
	...
	public void setIsSuperHost(boolean isSuperHost) { this.isSuperHost = isSuperHost; } 
